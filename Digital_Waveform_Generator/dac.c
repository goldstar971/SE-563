...
void cus(void){
	...
	uint32_t test=(sine(1,dac_state.sample)+sine(1,dac_state.sample*3)/3+
	sine(1,dac_state.sample*5)/5+sine(1,dac_state.sample*7)/7+sine(1,dac_state.sample*9)/9); //round up
	DAC1->DHR12R2=test;
}
